...
forecast.innerHTML= ""
    ...
    <div class="city-temp-max">Low Temp: ${Math.round(list[i].main.temp)}<sup>°C</sup>
    <div class="city-temp-max">Wind: ${Math.round(list[i] .wind.speed)}<sup>MPH</sup>
    <div class="city-temp-max">Humidity: ${Math.round(list[i].main.humidity)}<sup></sup>
    </div>
